...
class BatchJobStatusMapperTest {
  ...
  static Stream<Arguments> toDtoArgs() {
    ...
    return Stream.of(
      ...
      Arguments.of(
        ...
        new BatchJobStatusDto().jobName("jobName").reindexType(INCREMENTAL).linesRead(0L).linesSent(0L)
          .status("STARTED")
      ),
      Arguments.of(
        ...
        new BatchJobStatusDto().jobName("jobName").linesRead(0L).linesSent(0L).status("STARTED")
      ),
      Arguments.of(
      ...
      Arguments.of(
        ...
        new BatchJobStatusDto().jobName("jobName").linesRead(0L).linesSent(0L).status("COMPLETED")
      ),
      Arguments.of(
      ...
      Arguments.of(
        ...
        new BatchJobStatusDto().jobName("jobName").startDate(of(startTime, UTC)).endDate(of(endTime, UTC))
      ...
      Arguments.of(
        ...
        new BatchJobStatusDto().jobName("jobName").executionRound(0).linesRead(0L).linesSent(0L).status("STARTED")
      )
    );
  }
  ...
  void toDto(String description, String stepName, BatchJobExecution execution, BatchJobStatusDto expected) {
    assertThat(mapper.toDto(execution, "jobName", stepName)).isEqualTo(expected);
  }
