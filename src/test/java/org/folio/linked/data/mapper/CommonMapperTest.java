...
class CommonMapperTest {
  ...
  @BeforeEach
  public void setUp() {
    commonMapper = new CommonMapperImpl(resourceTypeService, predicateService, OBJECT_MAPPER);
  }
  ...
  void toProperty_shouldThrowNpe_ifGivenResourceIsNull() {
    ...
    // when
    NullPointerException thrown = assertThrows(NullPointerException.class, () -> commonMapper.toProperty(resource));
  ...
  void toProperty_shouldReturnEmptyProperty_ifGivenResourceContainsEmptyDoc() {
    ...
    // when
    var property = commonMapper.toProperty(resource);
  ...
  void toProvisionActivity_shouldThrowNpe_ifGivenResourceIsNull() {
    ...
    NullPointerException thrown = assertThrows(NullPointerException.class,
      () -> commonMapper.toProvisionActivity(resource));
  ...
  void toProvisionActivity_shouldReturnEmptyProperty_ifGivenResourceContainsEmptyDoc() {
    ...
    // when
    var provisionActivity = commonMapper.toProvisionActivity(resource);
  ...
  void toUrl_shouldThrowNpe_ifGivenResourceIsNull() {
    ...
    // when
    NullPointerException thrown = assertThrows(NullPointerException.class, () -> commonMapper.toUrl(resource));
  ...
  void toUrl_shouldReturnEmptyProperty_ifGivenResourceContainsEmptyDoc() {
    ...
    // when
    var url = commonMapper.toUrl(resource);
  ...
  void addMappedResources_shouldThrowNpe_ifGivenSubResourceMapperIsNull(@Mock Resource resource,
    ...
    // when
    NullPointerException thrown = assertThrows(NullPointerException.class,
      () -> commonMapper.addMappedResources(subResourceMapper, resource, consumer, Instance.class));
  ...
  void addMappedResources_shouldThrowNpe_ifGivenDestinationIsNull(@Mock SubResourceMapper subResourceMapper,
    ...
    // when
    NullPointerException thrown = assertThrows(NullPointerException.class,
      () -> commonMapper.addMappedResources(subResourceMapper, resource, consumer, destination));
  ...
  void addMappedResources_shouldAddDestinationObjectToGivenConsumer_ifGivenResourceIsEmpty(
    ...
    // when
    commonMapper.addMappedResources(subResourceMapper, resource, bibframeResponse::addInstanceItem, Instance.class);
  ...
  void addMappedProperties_shouldThrowNpe_ifGivenResourceIsNull(@Mock Consumer<Property> consumer) {
    ...
    // when
    NullPointerException thrown = assertThrows(NullPointerException.class,
      () -> commonMapper.addMappedProperties(resource, predicate, consumer));
  ...
  void addMappedProperties_shouldDoNothing_ifGivenResourceHasNoEdges() {
    ...
    // when
    commonMapper.addMappedProperties(resource, predicate, immediateAcquisition::addApplicableInstitutionItem);
  ...
  void readResourceDoc_shouldThrowNpe_ifGivenResourceIsNull() {
    ...
    // when
    NullPointerException thrown = assertThrows(NullPointerException.class,
      () -> commonMapper.readResourceDoc(resource, dtoClass));
  ...
  void readResourceDoc_shouldReturnEmptyDto_ifGivenResourceHasNoDoc() {
    ...
    // when
    var result = commonMapper.readResourceDoc(resource, dtoClass);
  ...
  void addMappedPersonLookups_shouldThrowNpe_ifGivenResourceIsNull(@Mock Consumer<PersonField> personConsumer) {
    ...
    // when
    NullPointerException thrown = assertThrows(NullPointerException.class,
      () -> commonMapper.addMappedPersonLookups(resource, predicate, personConsumer));
  ...
  public void hash_shouldThrowNpe_ifGivenResourceIsNull() {
    ...
    // when
    NullPointerException thrown = assertThrows(NullPointerException.class, () -> commonMapper.hash(resource));
  ...
  public void hash_shouldReturnHashUtilResultForResourceDoc_ifGivenResourceContainsDoc() {
    ...
    // when
    var result = commonMapper.hash(resource);
  ...
  void toJson_shouldReturnEmptyJsonNodeForNullInput() throws JsonProcessingException {
    ...
    // when
    var jsonNode = commonMapper.toJson(object);
  ...
  void mapResourceEdges_shouldThrowNpe_ifGivenSourceIsNull(@Mock SubResourceMapper mapper) {
    ...
    // when
    NullPointerException thrown = assertThrows(NullPointerException.class,
      () -> commonMapper.mapResourceEdges(targets, source, predicate, mapper::toEntity));
  ...
  void mapResourceEdges_shouldThrowNpe_ifGivenMappingFunctionIsNull() {
    ...
    // when
    NullPointerException thrown = assertThrows(NullPointerException.class,
      () -> commonMapper.mapResourceEdges(targets, source, predicate, null));
  ...
  @Test
  public void mapResourceEdges_shouldAddMappedEdgesToResource_ifGivenDtoListIsNotEmpty(@Mock SubResourceMapper mapper) {
    // given
  ...
  void mapPropertyEdges_shouldThrowNpe_ifGivenSourceIsNull() {
    // given
    var targets = new ArrayList<Property>();
    Resource source = null;
    var predicate = "predicate";
    var type = "type";
    ...
    // when
    NullPointerException thrown = assertThrows(NullPointerException.class,
      () -> commonMapper.mapPropertyEdges(targets, source, predicate, type));
  ...
  public void mapPropertyEdges_shouldAddMappedEdgesToResource_ifGivenDtoListIsNotEmpty() {
    ...
    expectedTarget1.setResourceHash(commonMapper.hash(expectedTarget1));
    var dto2 = new Property().id("id2").label("label2").uri("uri2");
    var expectedTarget2 = new Resource()
      .setLabel(dto2.getLabel())
      .setType(expectedType)
      .setDoc(propertyToDoc(dto2));
    expectedTarget2.setResourceHash(commonMapper.hash(expectedTarget2));
    var targets = List.of(dto1, dto2);
    var source = new Resource();
  ...
  public void propertyToEntity_shouldThrowNpe_ifGivenPropertyIsNull() {
    ...
    // when
    NullPointerException thrown = assertThrows(NullPointerException.class,
      () -> commonMapper.propertyToEntity(property, type));
  ...
  public void propertyToEntity_shouldReturnCorrectEntity_ifGivenPropertyAndTypeNotNull() {
    ...
    // when
    var resource = commonMapper.propertyToEntity(property, type);
  ...
  public void provisionActivityToEntity_shouldThrowNpe_ifGivenProvisionActivityIsNull() {
    ...
    // when
    NullPointerException thrown = assertThrows(NullPointerException.class,
      () -> commonMapper.provisionActivityToEntity(dto, label, type));
  ...
  public void provisionActivityToEntity_shouldReturnCorrectEntity_ifGivenPropertyAndTypeNotNull() {
    ...
    expectedTarget1
      .setResourceHash(commonMapper.hash(expectedTarget1));
    ...
    expectedTarget2
      .setResourceHash(commonMapper.hash(expectedTarget2));
    var dto = new ProvisionActivity()
    ...
    // when
    var resource = commonMapper.provisionActivityToEntity(dto, label, type);
