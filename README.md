...
| AUTO_CONVERT_MARC_BIB_TO_GRAPH                      | false                                  | TEMPORARY VARIABLE: If true, bibliographic records will be automatically converted to the linked data graph when it is created in SRS. This env variable is added to facilitate performance testing and will be removed before release. |
