...
public class AuthorityUpdateMessageSender implements UpdateMessageSender {
  ...
  public void accept(Resource resource) {
    log.debug("Publishing Index update message for AUTHORITY with ID [{}]", resource.getId());
    var indexMessage = mapper.toIndex(resource, UPDATE);
