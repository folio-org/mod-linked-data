...
public class KafkaSearchSenderImpl implements KafkaSearchSender {
  ...
  private void indexUpdatedWork(LinkedDataWork newWorkIndex, Resource oldWork) {
  ...
  private void sendIndexCreate(LinkedDataWork index) {
  ...
  private void sendAuthorityIndexCreate(LinkedDataAuthority index) {
    var message = new ResourceIndexEvent()
      .id(UUID.randomUUID().toString())
      .type(CREATE)
  ...
  private void sendUpdate(LinkedDataWork newWorkIndex, LinkedDataWork oldWorkIndex) {
    var message = new ResourceIndexEvent()
      .id(UUID.randomUUID().toString())
      .type(UPDATE)
      .resourceName(SEARCH_RESOURCE_NAME)
  ...
  private void sendDelete(Long id) {
    var message = new ResourceIndexEvent()
      ...
      .type(DELETE)
      .resourceName(SEARCH_RESOURCE_NAME)
      ._new(new LinkedDataWork(id.toString()));
    bibliographicIndexEventProducer.sendMessages(List.of(message));
  }
