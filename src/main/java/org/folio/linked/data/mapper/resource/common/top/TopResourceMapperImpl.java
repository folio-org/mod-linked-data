...
@Log4j2
@Service
public class TopResourceMapperImpl implements TopResourceMapper {

  private final ObjectMapper objectMapper;
  private final Map<String, TopResourceMapperUnit> mapperUnits = new HashMap<>();

  @Autowired
  public TopResourceMapperImpl(List<TopResourceMapperUnit> mapperUnits, ObjectMapper objectMapper) {
  ...
  public ResourceDto toDto(@NonNull Resource source, @NonNull ResourceDto destination) {
    ...
    var mapper = source.getTypes()
      ...
      .filter(mapperUnits::containsKey)
      .map(this::getMapperUnit)
  ...
  private Optional<TopResourceMapperUnit> getMapperUnit(String typeUri) {
