...
public abstract class AbstractVariantTitleIT extends PostResourceIT {
  ...
  protected void validateGraph(Resource resource) {
    ...
    assertThat(getProperty(variantTitle, "http://bibfra.me/vocab/library/mainTitle")).isEqualTo("variant title");
    assertThat(getProperty(variantTitle, "http://bibfra.me/vocab/library/partNumber")).isEqualTo("part number");
    assertThat(getProperty(variantTitle, "http://bibfra.me/vocab/library/partName")).isEqualTo("part name");
    assertThat(getProperty(variantTitle, "http://bibfra.me/vocab/library/subTitle")).isEqualTo("sub title");
    assertThat(getProperty(variantTitle, "http://bibfra.me/vocab/library/variantType")).isEqualTo("variant type");
    assertThat(getProperty(variantTitle, "http://bibfra.me/vocab/lite/note")).isEqualTo("note text");
    assertThat(getProperty(variantTitle, "http://bibfra.me/vocab/lite/date")).isEqualTo("2026");
