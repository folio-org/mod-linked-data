# mod-linked-data
Copyright (C) 2024–2026 The Open Library Foundation
...
| MODULE_VERSION`*`                                           | -                                      | Must be exactly the same as `MODULE_VERSION` supplied to this module's associated sidecar container.                                                                                  |
...
| KAFKA_TENANT_FILTER_ENABLED`*`                              | false                                  | Enables tenant-aware Kafka message filtering for mixed-version deployments                                                                                                            |
...
| KAFKA_TENANT_FILTER_ENTITLEMENT_REFRESH_INTERVAL_SECONDS`*` | 900                                    | Interval in seconds for refreshing the tenant-entitlement cache                                                                                                                       |
...
| CACHE_TTL_VOCABULARIES_MS                                   | 18000000                               | Specifies time to live for `vocabularies` cache                                                                                                                                       |
...
| REINDEX_CHUNK_SIZE                                          | 1000                                   | Number of resources to process in a single chunk during reindexing                                                                                                                    |
| GRAPH_CLEANING_CHUNK_SIZE                                   | 1000                                   | Number of resources to process in a single chunk during graph cleaning                                                                                                                |
| GRAPH_CLEANING_MAX_ROUNDS                                   | 10                                     | The maximum amount of rounds allowed for GraphCleaningJob                                                                                                                             |
