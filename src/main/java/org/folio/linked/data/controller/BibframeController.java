...
public class BibframeController implements BibframeApi {
  ...
  @Override
  public ResponseEntity<BibframeResponse> updateBibframe(Long id, String okapiTenant,
                                                         BibframeRequest bibframeRequest) {
  ...
  @Override
  public ResponseEntity<BibframeShortInfoPage> getBibframeShortInfoPage(String type, String okapiTenant,
                                                                        Integer pageNumber, Integer pageSize) {
    return ResponseEntity.ok(resourceService.getBibframeShortInfoPage(type, pageNumber, pageSize));
  }
}
