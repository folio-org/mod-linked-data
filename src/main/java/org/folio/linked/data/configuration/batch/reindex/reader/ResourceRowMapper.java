...
import static org.folio.linked.data.configuration.batch.reindex.reader.IndexableResourceQueryBuilder.COL_DOC;
import static org.folio.linked.data.configuration.batch.reindex.reader.IndexableResourceQueryBuilder.COL_INCOMING_EDGES;
import static org.folio.linked.data.configuration.batch.reindex.reader.IndexableResourceQueryBuilder.COL_LABEL;
import static org.folio.linked.data.configuration.batch.reindex.reader.IndexableResourceQueryBuilder.COL_OUTGOING_EDGES;
import static org.folio.linked.data.configuration.batch.reindex.reader.IndexableResourceQueryBuilder.COL_TYPE_HASHES;
import static org.folio.linked.data.configuration.batch.reindex.reader.IndexableResourceQueryBuilder.EDGE_PREDICATE_HASH;
import static org.folio.linked.data.configuration.batch.reindex.reader.IndexableResourceQueryBuilder.EDGE_SOURCE_DOC;
import static org.folio.linked.data.configuration.batch.reindex.reader.IndexableResourceQueryBuilder.EDGE_SOURCE_HASH;
import static org.folio.linked.data.configuration.batch.reindex.reader.IndexableResourceQueryBuilder.EDGE_SOURCE_LABEL;
import static org.folio.linked.data.configuration.batch.reindex.reader.IndexableResourceQueryBuilder.EDGE_SOURCE_OUTGOING;
import static org.folio.linked.data.configuration.batch.reindex.reader.IndexableResourceQueryBuilder.EDGE_SOURCE_TYPES;
import static org.folio.linked.data.configuration.batch.reindex.reader.IndexableResourceQueryBuilder.EDGE_TARGET_DOC;
import static org.folio.linked.data.configuration.batch.reindex.reader.IndexableResourceQueryBuilder.EDGE_TARGET_HASH;
import static org.folio.linked.data.configuration.batch.reindex.reader.IndexableResourceQueryBuilder.EDGE_TARGET_LABEL;
import static org.folio.linked.data.configuration.batch.reindex.reader.IndexableResourceQueryBuilder.EDGE_TARGET_TYPES;
