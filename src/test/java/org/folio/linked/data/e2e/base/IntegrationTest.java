...
@SpringBootTest(classes = {KafkaAdminService.class, KafkaAutoConfiguration.class, FolioKafkaProperties.class,
  LinkedDataTopicProperties.class, LinkedDataApplication.class})
