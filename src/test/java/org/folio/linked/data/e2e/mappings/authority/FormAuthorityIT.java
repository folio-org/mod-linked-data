...
class FormAuthorityIT extends PostAuthorityIT {
    ...
    return """
      {
        "resource": {
          "_authority": {
            "profileId": 9,
            "http://bibfra.me/vocab/lite/name": ["Test Form Name"],
  ...
  protected void validateApiResponse(ResultActions apiResponse) {
    apiResponse
      .andExpect(jsonPath(AUTHORITY_PATH + "['profileId']").value(9))
      .andExpect(jsonPath(AUTHORITY_PATH + "['http://bibfra.me/vocab/lite/name'][0]").value("Test Form Name"));
