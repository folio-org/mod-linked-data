...
public class WorkSearchUpdateEventProducer implements UpdateResourceEventProducer {
  ...
  @Override
  public void accept(Resource resource, Resource newResource) {
    kafkaSearchSender.sendWorkUpdated(newResource, resource);
  }
}
